...
@section('CSS')
    <link rel="stylesheet" type="text/css" href="{{ asset('/css/aboutstyle2.css') }}">
...
@section('content')
    <div class="container homeContainer wow slideInDown" id="about">
        ...
        <!--<img src="{{asset('images/About/about gablia.png')}}" id="about_the_gablia" class="col-xs-12"/>-->
            ...
            <p class="about_text"><span>Open Source Community</span> a student community was found in Faculty of
