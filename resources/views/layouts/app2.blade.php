...
<body>
    ...
    <div class="navbar navbar-default ">
        <div class="container">
            <!--navbar logos-->
            <div class="row"> <img class=" logo  col-md-1 col-xs-3  " src="{{ asset('images/navbar/logo-osc.png')}}"> <img class=" osc col-md-4 col-xs-6   " src="{{ asset('images/navbar/osc-log.png')}}"> </div>
            ...
            <div class="row">
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav col-xs-10">
                        ...
                        <li>
                            <div class="dropdown">
                                <button class="btn btn-default btn-sm " type="button" data-toggle="dropdown">Committees <span class="caret"></span></button>
                    ...
                    <ul class="nav navbar-nav navbar-right col-xs-1">
                        <li>
                            <div class="dropdown ">
                                <button class="btn btn-sm btn-default " type="button" data-toggle="dropdown">Contact Us <span class="caret"></span></button>
