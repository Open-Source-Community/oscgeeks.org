...
@section('content')
    ...
    <div class="wow bounceIn" data-wow-duration="3s" data-wow-delay="0.5s" offset="200">
        ...
        <br>
		<div class="text-center">
		<h3 style="font-family: HANDVETICA;font-size:20px;color:darkslateblue;" class="hvr-float-shadow wow bounceInLeft" data-wow-duration="3s" data-wow-delay="0.5s" offset="200">
