...
designs using Blender.
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend1.png')}}" alt="Los Angeles">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend2.png')}}" alt="Chicago">
    </div>

    <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend4.png')}}" alt="New York">
    </div>
    
     <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend5.png')}}" alt="New York">
    </div>  
      
    <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend3.png')}}" alt="New York">
    </div>  
      
    <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend9.png')}}" alt="New York">
    </div> 
    
    <div class="item">
      <img class="img-responsive center-block" src="{{asset('/images/pages images/blender/blend7.png')}}" alt="New York">
    </div>
