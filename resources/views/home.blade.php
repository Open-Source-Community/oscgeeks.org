...
<div class="home" id="home" style="visibility:visible; display:block;">
    <div class="row ">
        <img class=" osc shapes col-lg-6 col-lg-offset-3 col-xs-8 col-xs-offset-2 "
             src="https://github.com/Open-Source-Community/oscgeeks.orgImages/blob/master/Minified%20Images/Background/osc.png?raw=true">
        ...
        <a href="{{url("about")}}"
           class="button col-lg-2 col-lg-offset-5 col-md-4 col-md-offset-4 col-sm-2 col-sm-offset-4 col-xs-4 col-xs-offset-4">START
            TOUR</a>
    </div>
</div>
